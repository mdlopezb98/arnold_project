    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
        <div class="widget-content-area br-4">
            <div class="widget-one">
                ...
                <h5>
                    <b> @if($selected_id == 0) Registrar Nueva Unidad de Medida @else Editar Unidad de Medida @endif</b>
                </h5>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
                            <div class="input-group">
                                ...
                                <div class="row g-2">
                                    <div class="col-md">
                                        <input type="text" class="form-control bg-light border-1 small" placeholder="Unidad de Medida" wire:model.lazy="name">
                                    </div>
                                    <div class="col-md">
                                        <input type="number" min="0" step="0.01" class="form-control bg-light border-1 small" placeholder="Rel. Libras" wire:model.lazy="relacion_lb">
                                    </div>
                                </div>
                            </div>
                        </div>
